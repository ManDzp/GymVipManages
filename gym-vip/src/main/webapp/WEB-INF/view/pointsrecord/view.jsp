			...
			<table class="tablebgcolor" cellspacing="1" cellpadding="2" width="100%" align="center" border="0">
				...
				<!-- 获取积分 -->
					<tr>
						...
						<td class="tdbgcolor35"><label>获取积分</label></td>
				...
				<!-- 兑换积分 -->
					<tr>
						<td class="lefttdbgcolor">类　　型：</td>
						<td class="tdbgcolor35"><label>兑换积分</label></td>
						<td class="lefttdbgcolor">积　　分：</td>
						<td class="tdbgcolor35"><label>${pointsRecord.points}</label></td>
					</tr>
					<tr>
						<td class="lefttdbgcolor">原始到期日期：</td>
						<td class="tdbgcolor35"><label><fmt:formatDate pattern="yyyy-MM-dd" value="${pointsRecord.oldexpiretime}" /></label></td>
