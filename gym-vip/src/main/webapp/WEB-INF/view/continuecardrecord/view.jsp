...
<script type="text/javascript" src="${ctx}/business/continuecardrecord/continuecardrecord.js${res_v}"></script>
</head>
			...
			<table class="tablebgcolor" cellspacing="1" cellpadding="2" width="100%" align="center" border="0">
				<tbody>
					<tr>
						...
						<td class="tdbgcolor"><label>${continueCardRecord.money}</label></td>
					</tr>
					<tr>
						<td class="lefttdbgcolor">到期日期：</td>
						<td class="tdbgcolor"><fmt:formatDate pattern="yyyy-MM-dd" value="${continueCardRecord.expiretime}" /></label></td>
					</tr>
					<tr>
						<td class="lefttdbgcolor">续卡时间：</td>
						<td class="tdbgcolor"><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${continueCardRecord.createtime}" /></label></td>
					</tr>
					<tr>
