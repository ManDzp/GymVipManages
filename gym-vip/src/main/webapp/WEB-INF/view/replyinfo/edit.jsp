	...
	<div class="page-content">
		...
		<form id="fm" method="post" enctype="application/x-www-form-urlencoded">
			<table class="tablebgcolor" width="100%" cellpadding="1" cellspacing="1" border="0" style="margin: 2px;">
				<tbody>
					<tr>
						<td class="lefttdbgcolor"><font color="#ff0000">*</font>标        题：</td>
						<td class="tdbgcolor"><input id="title" name="title"
							class="str" v_must="1" v_name="标  题" v_type="string" value="${replyInfo.title}" /></td>
					</tr>
					<tr>
						<td class="lefttdbgcolor"><font color="#ff0000">*</font>回复内容：</td>
						<td class="tdbgcolor">
