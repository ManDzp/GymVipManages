	...
	<table id="grid" style="width: getWidth(1); height: 100%" >
		<thead>	
			<tr>
				...
				<th data-options="field:'title',align:'left',formatter:getViewUrl,sortable:true,order:'desc'"
					width="25">标       题</th>
				<th data-options="field:'replycontent',align:'left',formatter:getViewUrl,sortable:true,order:'desc'"
					width="50">回复内容</th>	
			</tr>			
		</thead>
	</table>
