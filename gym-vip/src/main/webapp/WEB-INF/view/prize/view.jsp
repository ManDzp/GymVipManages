        ...
        <form id="fm">
            <table class="tablebgcolor" cellspacing="1" cellpadding="2" width="100%" align="center" border="0">
                <tbody>
                    ...
                    <tr>
                        <td class="lefttdbgcolor">奖品编码：</td>
                        <td class="tdbgcolor35"><label>${prize.prizeCode}</label></td>
                        <td class="lefttdbgcolor">奖 品 名：</td>
                        <td class="tdbgcolor35"><label>${prize.prizeName}</label></td>
                    </tr>
                    <tr>
                        <td class="lefttdbgcolor">单　　位：</td>
                        <td class="tdbgcolor" colspan="3"><label>${prize.prizeUnit}</label></td>
                    </tr>
                    <tr>
                        <td class="lefttdbgcolor">状　　态：</td>
                        <td class="tdbgcolor" colspan="3">
	                        <label>
	                            <c:if test="${prize.prizeStatus == '0'}">启用</c:if>
	                            <c:if test="${prize.prizeStatus == '1'}">停用</c:if>
	                        </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="tdbgcolor" colspan="3">
                            <textarea style="width: 100%;" rows="4" cols="10" readonly="readonly">${prize.prizeRemark}</textarea>
                        </td>
                    </tr>
                </tbody>
                </tbody>
