...
<script type="text/javascript" src="${ctx}/business/prize/list.js${res_v}"></script>
    ...
    <table id="grid" style="width: getWidth(1); height: 100%" >
        <thead>
            <tr>
                ...
                <th data-options="field:'prizeCode',align:'left',formatter:getViewUrl,sortable:true,order:'desc'"
                    width="20">奖品编码</th>
                <th data-options="field:'prizeName',align:'left',formatter:getViewUrl,sortable:true,order:'desc'"
                    width="20">奖品名</th>
                <th data-options="field:'prizeUnit',align:'left',formatter:getViewUrl,sortable:true,order:'desc'"
                    width="20">单位</th>
                <th data-options="field:'prizeStatus',align:'left',formatter:getStatusUrl,sortable:true,order:'desc'"
                    width="20">状态</th>
            </tr>
        </thead>
    </table>
