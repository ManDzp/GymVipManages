	...
	<table id="grid" style="width: getWidth(1); height: 100%" >
		<thead>	
			<tr>
				...
				<th data-options="field:'username',align:'left',formatter:getViewUrl,sortable:true,order:'desc'"
					width="50">会员账号</th>
				<th data-options="field:'displayname',align:'left',formatter:getViewUrl,sortable:true,order:'desc'"
					width="25">昵       称</th>	
			</tr>			
		</thead>
	</table>
