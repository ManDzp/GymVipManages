        ...
        <form id="fm">
            <table class="tablebgcolor" cellspacing="1" cellpadding="2" width="100%" align="center" border="0">
                <tbody>
                    ...
                    <tr>
                        <td class="lefttdbgcolor">私教编码：</td>
                        <td class="tdbgcolor35"><label>${personalTraining.personalTrainingCode}</label></td>
                        <td class="lefttdbgcolor">私教名称：</td>
                        <td class="tdbgcolor35"><label>${personalTraining.personalTrainingName}</label></td>
                    </tr>
                    <tr>
                        <td class="lefttdbgcolor">状　　态：</td>
                        <td class="tdbgcolor" colspan="3">
	                        <label>
	                            <c:if test="${personalTraining.personalTrainingStatus == '0'}">启用</c:if>
	                            <c:if test="${personalTraining.personalTrainingStatus == '1'}">停用</c:if>
	                        </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="tdbgcolor" colspan="3">
                            <textarea style="width: 100%;" rows="4" cols="10" readonly="readonly">${personalTraining.personalTrainingRemark}</textarea>
                        </td>
                    </tr>
                </tbody>
                </tbody>
