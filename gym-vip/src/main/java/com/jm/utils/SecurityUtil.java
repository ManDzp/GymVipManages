...
public class SecurityUtil
{
	 ...
	 * @return 过滤后的出参字符串
	 */
	public static String inPutAllFilter(final String userInput)
	{
		if (userInput == null)
			return "";
	 ...
	 * @return
	 */
	private static String formatDisableScripting(final String strInput)
	{
	 ...
	 * @return 过滤完得字符串
	 */
	private static String filterStrings(final String strInput)
	{
		String tempInput = strInput;
	...
	public static String formatRemoveSQL(String strSQL)
	{
		...
		Pattern p = Pattern.compile(badStatementExpression,
				Pattern.CASE_INSENSITIVE);
		Matcher matcher = p.matcher(strSQL);
		String tempInput = matcher.replaceAll(" ").replace("\'", "")
